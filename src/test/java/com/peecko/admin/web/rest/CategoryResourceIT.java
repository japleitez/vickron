...
import com.peecko.admin.repository.CategoryRepository;
...
class CategoryResourceIT {
    ...
    void putExistingCategory() throws Exception {
        ...
        updatedCategory.code(UPDATED_CODE).type(UPDATED_TYPE).active(UPDATED_ACTIVE).name(UPDATED_NAME).label(UPDATED_LABEL);
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.code(UPDATED_CODE).name(UPDATED_NAME).label(UPDATED_LABEL);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.code(UPDATED_CODE).type(UPDATED_TYPE).active(UPDATED_ACTIVE).name(UPDATED_NAME).label(UPDATED_LABEL);
