...
class PersonResourceIT {
    ...
    void createPerson() throws Exception {
        ...
        assertThat(testPerson.getLicense()).isEqualTo(DEFAULT_LICENSE);
        assertThat(testPerson.getStart()).isEqualTo(DEFAULT_START);
        assertThat(testPerson.getEnd()).isEqualTo(DEFAULT_END);
    }
    ...
    void putExistingPerson() throws Exception {
        ...
        assertThat(testPerson.getLicense()).isEqualTo(UPDATED_LICENSE);
        assertThat(testPerson.getStart()).isEqualTo(UPDATED_START);
        assertThat(testPerson.getEnd()).isEqualTo(UPDATED_END);
    }
